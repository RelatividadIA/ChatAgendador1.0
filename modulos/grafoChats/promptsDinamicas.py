...
def recargarPrompts():
    ...
    6. En el caso que la conversación regrese a este bot porque el usuario pidió correcciones, asegúrate que el nuevo valor reservado sea diferente de {controller.obtener_valor_cliente('nombres')} y de sus apellidos erróneos {controller.obtener_valor_cliente('apellidos')}.
    """
    ...
    5. En el caso que la conversación regrese a este bot porque el usuario pidió correcciones, asegúrate que el nuevo valor reservado sea diferente de {controller.obtener_valor_cliente('nombres')} y que sea diferente a sus apellidos {controller.obtener_valor_cliente('apellidos')}.
    """
